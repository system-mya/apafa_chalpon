...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2019 a las 23:55:38
...
VALUES ((SELECT ca.id_concepto FROM concepto_apafa ca INNER JOIN anhio_lectivo a ON a.idanhio=ca.id_anhio WHERE a.anhio=dato_anhio AND a.condicion_anhio='A' AND a.estado_anhio=1),apoderado,(SELECT ca.monto_concepto FROM concepto_apafa ca INNER JOIN anhio_lectivo a ON a.idanhio=ca.id_anhio WHERE a.anhio=dato_anhio AND a.condicion_anhio='A' AND a.estado_anhio=1),CURDATE(),NOW())$$
...
CREATE TABLE `concepto_apafa` (
  ...
  `id_tipo_concepto` smallint(6) NOT NULL,
...
INSERT INTO `concepto_apafa` (`id_concepto`, `descripcion_concepto`, `id_tipo_concepto`, `id_anhio`, `monto_concepto`, `estado_concepto`) VALUES
(1, 'CUOTA APAFA 2019', 1, 2, 59, b'1');
...
(11, 1, 1, 59, '2019-06-07', '2019-06-07 17:20:56', 'P'),
(12, 1, 2, 59, '2019-06-07', '2019-06-07 17:23:44', 'P');
...
(12, '2019-06-07', 1, 1, 2, 1, 1, b'1'),
(13, '2019-06-07', 1, 4, 2, 1, 1, b'1'),
(14, '2019-06-07', 2, 3, 2, 1, 2, b'1');
...
CREATE TABLE `recibo` (
  ...
  `num_recibo` char(18) NOT NULL,
  `obser_recibo` varchar(100) NOT NULL,
  `estado_recibo` bit(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tipo_concepto` (
  `id_tconcepto` smallint(6) NOT NULL,
  `cod_tconcepto` char(2) NOT NULL,
  `nombre_tconcepto` varchar(50) NOT NULL,
  `estado_tconcepto` bit(1) NOT NULL DEFAULT b'1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tipo_concepto` (`id_tconcepto`, `cod_tconcepto`, `nombre_tconcepto`, `estado_tconcepto`) VALUES
(1, '00', 'CUOTA APAFA', b'1'),
(2, '01', 'REUNION GENERAL', b'1');
...
--
ALTER TABLE `detalle_deuda`
  MODIFY `id_detalle_deuda` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `matricula`
  MODIFY `id_matricula` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `tipo_concepto`
  MODIFY `id_tconcepto` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `concepto_apafa`
  ADD CONSTRAINT `concepto_apafa_ibfk_1` FOREIGN KEY (`id_tipo_concepto`) REFERENCES `tipo_concepto` (`id_tconcepto`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `detalle_recibo`
  ADD CONSTRAINT `detalle_recibo_ibfk_1` FOREIGN KEY (`id_recibo`) REFERENCES `recibo` (`id_recibo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalle_recibo_ibfk_2` FOREIGN KEY (`id_detalle_deuda`) REFERENCES `detalle_deuda` (`id_detalle_deuda`) ON DELETE CASCADE ON UPDATE CASCADE;
