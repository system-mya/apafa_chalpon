...
--
-- Servidor: localhost
-- Tiempo de generación: 22-06-2019 a las 06:48:08
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pa_listar_apoderados_reunion`(IN `reunion` SMALLINT, IN `anhio` CHAR(4))
    NO SQL
SELECT m.id_apoderado,CONCAT(ap.apellidos_apoderado,' ',ap.nombres_apoderado) AS apoderado,GROUP_CONCAT(a.apellidos_alumno,' ',a.nombres_alumno,'
