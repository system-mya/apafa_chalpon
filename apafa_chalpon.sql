...
--
-- Servidor: localhost
-- Tiempo de generación: 11-06-2019 a las 07:12:10
...
CREATE TABLE IF NOT EXISTS `recibo` (
  ...
  `obser_recibo` varchar(100) DEFAULT NULL,
...
INSERT INTO `recibo` (`id_recibo`, `id_apoderado`, `id_usuario`, `mtotal_recibo`, `freg_recibo`, `num_recibo`, `obser_recibo`, `estado_recibo`) VALUES
(1, 1, 46, 20.5, '2019-06-07 01:09:24', '1668-20190607-1', 'sdgdsg', b'1');
