...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2019 a las 00:08:42
...
SELECT m.id_apoderado,CONCAT(ap.apellidos_apoderado,' ',ap.nombres_apoderado) AS apoderado,GROUP_CONCAT(a.apellidos_alumno,' ',a.nombres_alumno,'<br>') AS matriculados 
FROM matricula m 
...
--
ALTER TABLE `concepto_apafa`
  MODIFY `id_concepto` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `detalle_deuda`
  MODIFY `id_detalle_deuda` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
ALTER TABLE `matricula`
  MODIFY `id_matricula` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
