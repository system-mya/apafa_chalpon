...
--
-- Servidor: localhost
-- Tiempo de generación: 18-06-2019 a las 05:50:01
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `pa_listar_compras_anhio`(IN `dato_anhio` INT)
    NO SQL
SELECT * FROM compra
...
(19, 1, 2, 59, '2019-06-17', '2019-06-17 22:23:24', 'P');
