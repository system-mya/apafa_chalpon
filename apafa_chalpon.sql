...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2019 a las 23:23:06
...
SELECT r.id_reunion, r.motivo_reunion,r.fecha_reunion,r.id_concepto,r.estado_reunion,c.descripcion_concepto,
...
(20, 1, 1, 20, '2019-06-05', '2019-06-19 16:46:06', 'P');
...
CREATE TABLE `libro_matricula` (
  ...
  `id_libro` smallint(6) NOT NULL,
  `entrego_libro` char(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `reunion` (`id_reunion`, `motivo_reunion`, `fecha_reunion`, `id_concepto`, `estado_reunion`) VALUES
(1, 'SE CITA A LA ASAMBLEA GENERAL', '2019-06-21', 3, b'1');
...
CREATE TABLE `reunion_apoderado` (
  `id_reunion` smallint(6) NOT NULL,
  `id_apoderado` smallint(6) NOT NULL,
  `asistio_reunion` char(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indices de la tabla `reunion_apoderado`
--
...
--
ALTER TABLE `concepto_apafa`
  MODIFY `id_concepto` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `libro`
  MODIFY `id_libro` smallint(6) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `recibo`
  MODIFY `id_recibo` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `reunion`
  ADD CONSTRAINT `reunion_ibfk_1` FOREIGN KEY (`id_concepto`) REFERENCES `concepto_apafa` (`id_concepto`);
