...
app.post('/api/tesoreria/listar_recibos_apoderados', (req, res) => {
    tesoreria.listar_recibos_apoderado(req.body,res);
});

//LLAMADA LISTAR REUNIONES
app.post('/api/tesoreria/listar_reuniones_apoderado', (req, res) => {
    tesoreria.listar_reuniones_apoderado(req.body,res);
});
...
//NOTIFICACIONES 
app.get('/api/tesoreria/notificaciones',(req,res)=>{
    tesoreria.notificaciones(res);
 })
