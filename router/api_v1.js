...
//POST PARA INICIAR SESION APLICATIVO MOVIL
app.post('/api/administracion/iniciar_sesion_app', (req, res) => {
    admin.iniciar_sesion_app(req.body, res);
});
...
//LLAMADA LISTAR HISTORIAL DE MATRICULAS
app.post('/api/apafa/listar_historial_matricula', (req, res) => {
    apafa.listar_historial_matricula(req.body,res);
});

//LLAMADA OBTENER TOTAL DE DEUDA
app.post('/api/apafa/obtener_total_deuda_xanhio', (req, res) => {
    apafa.obtener_total_deuda_xanhio(req.body,res);
});
...
//LLAMADO OBTENER PERFIL ALUMNO
app.post('/api/apafa/obtener_perfil_alumno', (req, res) => {
    apafa.obtener_perfil_alumno(req.body, res);
});
...
//LLAMADA LISTA DE DEUDA POR APODERADO Y AÑO
app.post('/api/tesoreria/listar_deuda_apo_anhio', (req, res) => {
    tesoreria.listar_deuda_apo_anhio(req.body,res);
});
...
app.post('/api/tesoreria/eliminar_reunion', (req, res) => {
...
//LLAMADA LISTAR RECIBOS
app.post('/api/tesoreria/listar_recibos_apo_anhio', (req, res) => {
    tesoreria.listar_recibos_apo_anhio(req.body,res);
});

//LLAMADA LISTAR REUNIONES
app.post('/api/tesoreria/listar_reuniones_apo_anhio', (req, res) => {
    tesoreria.listar_reuniones_apo_anhio(req.body,res);
});

//LLAMADA INSERTAR NUEVO TOKEN
app.post('/api/tesoreria/insertar_token', (req, res) => {
    tesoreria.insertar_token(req.body,res);
});

//NOTIFICACIONES 
app.post('/api/tesoreria/notificaciones',(req,res)=>{
    tesoreria.notificaciones(req.body,res);
 })
